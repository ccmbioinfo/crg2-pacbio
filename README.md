...
crg2-pacbio outputs CSV reports that can be used by genome analysts to identify rare genetic variants associated with a patient phenotypes. The reports are outlined briefly below under 'Pipeline Outputs'. crg2-pacbio attempts to identify true compound heterozygous variant pairs across small variants, SVs, and CNVs; the implementation details are described [here](https://sickkidsca.sharepoint.com/:w:/r/sites/thecenterforcomputationalmedicineworkspace/Shared%20Documents/Translational%20Genomics/LRWGS/Pipeline_updates/compound_hets/Compound_het_variant_annotation.docx?d=we15df7709565420cb6bd6b99df4babc7&csf=1&web=1&e=aFhS3h). Gene compound heterozygous status is annotated in the small variant, SV, and CNV reports in the 'CH_status' and 'CH_variant_types' columns. 
